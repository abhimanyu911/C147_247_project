...
def main(config: DictConfig):
    ...
    datamodule.setup("fit")  # Make sure the datasets are initialized

    train_loader = datamodule.train_dataloader()
    first_batch = next(iter(train_loader))

    inputs, targets = first_batch["inputs"], first_batch["targets"]

    print("Inputs shape:", inputs.shape)   # Expected shape: (T, N, B, C, F)
